          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-16 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-xl text-gray-700 mb-6 leading-relaxed">
                We are a team of Sudanese technologists who rebuilt our lives and careers in East Africa. 
                Together, we channel enterprise-grade engineering into practical solutions that empower NGOs, 
                startups, and growing businesses.
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                Blue Team blends product-grade engineering (ERP, CRM, secure cloud, mobile) with a human-centered 
                approach. We build with frontline teams, document everything, and support reliable operations long after launch.
              </p>
            </div>
          </div>
