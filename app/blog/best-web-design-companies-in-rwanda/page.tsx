        ...
        <article className="py-12 bg-white">
          <div className="max-w-3xl mx-auto px-6">
            <div className="prose prose-lg max-w-none prose-headings:font-heading prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-relaxed prose-ul:text-gray-700 prose-strong:text-gray-900">
              ...
              <p>Evaluate potential partners based on their portfolio, looking for examples that demonstrate capabilities relevant to your project. Consider whether you need basic <a href="/web-design-rwanda" class="text-primary hover:text-primary-dark hover:underline">web design services in Rwanda</a> or more comprehensive <a href="/web-development-rwanda" class="text-primary hover:text-primary-dark hover:underline">web development services in Rwanda</a> that include custom functionality and integrations.</p>
